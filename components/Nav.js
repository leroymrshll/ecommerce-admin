...
export default function Nav({show}) {
    ...
    return (
        <aside className={(show ? "left-0" : "-left-full")+" top-0 text-gray-500 p-4 fixed h-full w-5/12 bg-bgGray md:static md:w-auto transition-all"}>
            <Link href={"/products"} className="flex gap-1 mb-4 mr-4">
